...
<div class="container-fluid">
  ...
  @endif
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">Faculty Book Issue List</h1>
  <!-- DataTales Example -->
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <div class="row">
        <div class="col-md-8">
          <h6 class="m-0 font-weight-bold text-primary">Faculty Book Issue List</h6>
        </div>
        <div class="col-md-4">
        <?php
            $date = date('Y-m-d');
...
$(document).ready(function(){
  ...
  function fetch_data(academic = '')
  {
    ...
    serverSide: true,
    ajax: {
      url: "{{ route('admin.facultyBookIssue.index') }}",
