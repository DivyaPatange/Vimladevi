  ...
  <div class="row justify-content-center">
    <div class="col-lg-12">
      ...
      <div class="card shadow mb-4">
        <div class="card-body">
        <iframe src="{{ URL::to('/') }}/Pdf/{{$journal->file}}#toolbar=0&navpanes=0&scrollbar=0" title="PDF in an i-Frame" frameborder="0" scrolling="auto" style="width:100%; height:500px"></iframe>
        </div>
      </div>
    </div>
  </div>
